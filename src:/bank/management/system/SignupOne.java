...
public class SignupOne extends JFrame implements ActionListener {
    long random;
    JTextField nameTextField, fnameTextField, emailTextField, addressTextField, cityTextField, provinceTextField, postalTextField;
    JButton next;
    ...
    SignupOne() {
        ...
        postalTextField.setFont(new Font("Raleway", Font.BOLD, 14));
        postalTextField.setBounds(300, 590, 400, 30);
        add(postalTextField);
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        try {
            if (name.equals("")) {
                ...
                Conn c = new Conn();
                String query = "insert into signup values ('" + formno + "', '" + name + "', '" + fname + "', '" + dob + "', '" + gender + "', '" + email + "', '" + marital + "', '" + address + "', '" + city + "', '" + province + "', '" + postal + "')";
